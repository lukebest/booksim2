...
UPDATES = {
    ...
    ("gather", 1): (205, 191, 205, 1.0000),
    ("gather", 4): (769, 764, 769, 1.0000),
    ("gather", 16): (3061, 3056, 3061, 1.0000),
    ("gather", 64): (12229, 12224, 12229, 1.0000),
    ("allgather", 1): (235, 191, 205, 0.8723),
    ("allgather", 4): (778, 764, 769, 0.9884),
    ("allgather", 16): (3070, 3056, 3061, 0.9971),
    ("allgather", 64): (12238, 12224, 12229, 0.9993),
