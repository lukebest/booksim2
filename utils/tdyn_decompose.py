...
def main():
    ...
    # Worst-case corner-to-corner hop counts must track --mx/--my (defaults
    # dx=5, dy=7 are only correct for the 6×8 mesh).
    dx, dy = args.mx - 1, args.my - 1
    bg = bg_decompose(dx=dx, dy=dy, h=args.h, v=args.v)
