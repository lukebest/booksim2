...
{svg_mesh(highlight_nodes=[sa.DEFAULT_ROOT])}</div>""")
    ...
    parts.append("<h2>5. 故障处理算法</h2>")
    parts.append("""<h3>5.1 链路故障</h3>
